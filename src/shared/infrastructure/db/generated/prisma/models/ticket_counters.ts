...
// @ts-nocheck 
/*
 * This file exports the `ticket_counters` model and its related types.
 *
...
export type GetTicket_countersAggregateType<T extends Ticket_countersAggregateArgs> = {
      [P in keyof T & keyof AggregateTicket_counters]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTicket_counters[P]>
    : Prisma.GetScalarType<T[P], AggregateTicket_counters[P]>
}
...
type GetTicket_countersGroupByPayload<T extends ticket_countersGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Ticket_countersGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Ticket_countersGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Ticket_countersGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Ticket_countersGroupByOutputType[P]>
      }
    >
  >
...
export type ticket_countersCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ticket_countersFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ticket_countersDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ticket_counters'], meta: { name: 'ticket_counters' } }
  /**
   ...
   * })
  **/
  count<T extends ticket_countersCountArgs>(
    args?: Prisma.Subset<T, ticket_countersCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Ticket_countersCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ticket_countersGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ticket_countersGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTicket_countersGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
