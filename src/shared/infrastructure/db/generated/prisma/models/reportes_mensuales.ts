...
// @ts-nocheck 
/*
 * This file exports the `reportes_mensuales` model and its related types.
 *
...
export type GetReportes_mensualesAggregateType<T extends Reportes_mensualesAggregateArgs> = {
      [P in keyof T & keyof AggregateReportes_mensuales]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateReportes_mensuales[P]>
    : Prisma.GetScalarType<T[P], AggregateReportes_mensuales[P]>
}
...
type GetReportes_mensualesGroupByPayload<T extends reportes_mensualesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Reportes_mensualesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Reportes_mensualesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Reportes_mensualesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Reportes_mensualesGroupByOutputType[P]>
      }
    >
  >
...
export type reportes_mensualesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<reportes_mensualesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface reportes_mensualesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['reportes_mensuales'], meta: { name: 'reportes_mensuales' } }
  /**
   ...
   * })
  **/
  count<T extends reportes_mensualesCountArgs>(
    args?: Prisma.Subset<T, reportes_mensualesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Reportes_mensualesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends reportes_mensualesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, reportes_mensualesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetReportes_mensualesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
