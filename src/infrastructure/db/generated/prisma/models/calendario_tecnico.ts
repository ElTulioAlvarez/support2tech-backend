...
// @ts-nocheck 
/*
 * This file exports the `calendario_tecnico` model and its related types.
 *
...
export type GetCalendario_tecnicoAggregateType<T extends Calendario_tecnicoAggregateArgs> = {
      [P in keyof T & keyof AggregateCalendario_tecnico]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCalendario_tecnico[P]>
    : Prisma.GetScalarType<T[P], AggregateCalendario_tecnico[P]>
}
...
type GetCalendario_tecnicoGroupByPayload<T extends calendario_tecnicoGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Calendario_tecnicoGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Calendario_tecnicoGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Calendario_tecnicoGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Calendario_tecnicoGroupByOutputType[P]>
      }
    >
  >
...
export type calendario_tecnicoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<calendario_tecnicoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface calendario_tecnicoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['calendario_tecnico'], meta: { name: 'calendario_tecnico' } }
  /**
   ...
   * })
  **/
  count<T extends calendario_tecnicoCountArgs>(
    args?: Prisma.Subset<T, calendario_tecnicoCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Calendario_tecnicoCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends calendario_tecnicoGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, calendario_tecnicoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCalendario_tecnicoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
